...
class AutorAdmin (admin.ModelAdmin):
    ...
    list_editable = ('data_nascimento', 'data_falecimento',
                     'curriculo_lattes', 'rosto',)
...
class LivroAdmin (admin.ModelAdmin):
    list_display = ('isbn', 'edicao', 'titulo', 'autor', 'ano',
                    'editora', 'categoria', 'num_page', 'capa',)
    list_editable = ('edicao', 'titulo', 'autor', 'ano',
                     'editora', 'categoria', 'num_page', 'capa',)
    search_fields = ('isbn', 'edicao', 'titulo', 'autor', 'ano',
                     'editora', 'categoria', 'num_page', 'capa',)
